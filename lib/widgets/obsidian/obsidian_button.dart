  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        transform: Matrix4.identity()..scale(pressed ? 0.99 : 1.0),
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: !enabled ? null : (pressed ? null : (isPrimary ? ObsidianTokens.clayMilkOutDark : ObsidianTokens.clayOutSmDark)),
        ),
